...
class Tela_Resultado_Vol_Util extends StatefulWidget {
  @override
  _Tela_Resultado_Vol_UtilState createState() => _Tela_Resultado_Vol_UtilState();
}
        ...
        body: ListView(
          children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Contribuição Diária da Ocupação: $contDiariaOcup L/dia",
                          style: TextStyle(color: Colors.white)),
                      Text("Período de Detenção do Esgoto: $pDetEsgoto dia", style: TextStyle(color: Colors.white)),
                      Text("Contribuição de lodo fresco: $lF L/unidade x dia", style: TextStyle(color: Colors.white)),
                      Text("Intervalo entre as limpezas: $valor3_selecionado", style: TextStyle(color: Colors.white)),
                      Text("Temperatura média do mês mais frio: $qntidadeTempEmDouble °C",
                          style: TextStyle(color: Colors.white)),
                      Text("Taxa de acumulação de lodo (K): $K", style: TextStyle(color: Colors.white)),
                    ],
                  ),
                ),
              ),
            ...
            Padding(
              ...
              child: Text(
                "Volume Necessário da Fossa Séptica:",
            ...
            Padding(
              padding: EdgeInsets.all(12.0),
              child: Text(
                "${calcularVolumeUtil(volumeUtil).toStringAsPrecision(3)} m³",
                textAlign: TextAlign.center,
