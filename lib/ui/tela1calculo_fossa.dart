  ...
  List<DropdownMenuItem<String>> get dropdownItems2 {
    if (valor1_selecionado == "Permanente") {
      ...
      List<DropdownMenuItem<String>> menuItems3 = [
        ...
        DropdownMenuItem(
            child: Text("08 - Edifícios públicos ou\n comerciais"), value: "08 - Edifícios públicos ou\n comerciais"),
        DropdownMenuItem(
      ...
      if (valor2_selecionado == "06 - Fábrica em geral") {
        ...
        lF = 0.20;
        tipagem = "pessoas";
      } else if (valor2_selecionado == "08 - Edifícios públicos ou\n comerciais") {
        contDiaria = 50;
        lF = 0.20;
        tipagem = "pessoas";
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        boxShadow: [BoxShadow(color: Colors.black, spreadRadius: 0.00, blurRadius: 3.0)],
                        gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: const [
                  ...
                  Padding(
                    ...
                    child: (TextFormField(
                      ...
                      style:
                          TextStyle(color: Color.fromRGBO(255, 191, 64, 1), fontSize: 15, fontWeight: FontWeight.bold),
                      controller: controleQntd,
                      decoration: InputDecoration(
                        enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.black, width: 2.5)),
                        disabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(color: Color.fromRGBO(120, 120, 120, 0.5), width: 3.0)),
                        focusedBorder: OutlineInputBorder(
                            borderSide: BorderSide(color: Color.fromRGBO(255, 191, 64, 1), width: 3.0)),
                        labelStyle: TextStyle(color: Color.fromRGBO(255, 191, 64, 1)),
                        hintText: "Ex.: 5",
                        border: OutlineInputBorder(
                            borderSide: BorderSide(color: Color.fromRGBO(255, 191, 64, 1), width: 2),
